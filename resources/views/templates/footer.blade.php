        ...
        <div class="row text-center text-md-start">
            ...
            <div class="col-6 col-md-4 mb-4 mb-md-0 text-start text-md-start">
                ...
                <ul class="list-unstyled text-body-secondary small">
                    <li class="mb-2 d-flex align-items-start">
                        ...
                        <span>Rivadavia 1189, Corrientes</span>
                    </li>
                    <li class="mb-2 d-flex align-items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#622b16" class="bi bi-envelope-fill me-2 mt-1 flex-shrink-0" viewBox="0 0 16 16">
                            <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z"/>
                        </svg>
                        <span class="text-break">maie.dulces@gmail.com</span>
                    </li>
                    <li class="d-flex align-items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#622b16" class="bi bi-telephone-fill me-2 mt-1 flex-shrink-0" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
                        </svg>
                        <span>+54 9 3794 00-4039</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-12 col-md-4 d-flex flex-column align-items-center align-items-md-end">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="https://wa.me/5493794004039" target="_blank" style="color: #622b16;">
